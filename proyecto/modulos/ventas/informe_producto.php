...
if (isset($mes) || isset($fechaDesde) && isset($fechaHasta)) {
    if (!empty($mes) || !empty($fechaDesde) && !empty($fechaHasta)) {
        $sql = "SELECT factura.fecha , factura.numero, factura.tipo,i.precio, i.nombre, SUM(dp.cantidad * dp.precio) AS total 
            FROM factura
            ...
            <div class="min-height-200px">
                <div class="pd-20 card-box mb-30">
                    <div class="wizard-content">
                        <div class="clearfix">
                            <h4 class="text-black h4">Informe de Productos mas Vendidos</h4>
                        </div>
