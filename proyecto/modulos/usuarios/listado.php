									...
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
												<a class="dropdown-item" href="detalle.php?id=<?=$usuario->getIdUsuario();?>"><i class="dw dw-eye"></i> View</a>
												<a class="dropdown-item" href="modificar.php?id=<?=$usuario->getIdUsuario();?>"><i class="dw dw-edit2"></i> Modificar</a>	
											</div>
										</div>
									</td>
								</tr>
