		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="card-box mb-30">
					<div class="pd-20">
						<h4 class="text-blue h4">Listado de Forma de Pagos</h4>
					</div>
					<div class="pb-20">
						...
						<table class="data-table table stripe hover nowrap">
							...
							<tbody>
								...
								<tr >
									<td class="table-plus"> <?= $formaPago->getIdFormaPago(); ?> </td>
									...
									<td>	
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
												...
												<a class="dropdown-item" href="modificar.php?id=<?=$formaPago->getIdFormaPago();?>"><i class="dw dw-edit2"></i> Modificar</a>
