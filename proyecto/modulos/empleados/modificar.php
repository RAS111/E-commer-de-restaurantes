		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<h4 class="text-black h4">Modificar Empleado</h4>
					</div>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<label>Nombre</label>
											<input type="text" name="txtNombre" id="txtNombre" class="form-control" value="<?= $empleado->getNombre(); ?>">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											<label>Apellido</label>
											<input type="text" name="txtApellido" id="txtApellido" class="form-control" value="<?= $empleado->getApellido(); ?>">
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<select name="cboSexo" id="cboSexo" class="custom-select form-control">
												...
												<?php if ($empleado->getSexo() == "Femenino"): ?>
													<option value="Femenino" selected><?=$empleado->getSexo()?></option>
													<option value="Masculino">Masculino</option>
													<option value="Otro">Otro</option>
												<?php elseif($empleado->getSexo() == "Masculino"):?>
													<option value="Femenino">Femenino</option>
													<option value="Masculino" selected><?=$empleado->getSexo()?></option>
													<option value="Otro">Otro</option>
												<?php elseif($empleado->getSexo() == "Otro"):?>
													<option value="Femenino">Femenino</option>
													<option value="Masculino">Masculino</option>
													<option value="Otro" selected><?=$empleado->getSexo()?></option>
												<?php endif ?>
											</select>
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="date" name="txtFechaNacimiento" id="txtFechaNacimiento" class="form-control date-picker" value="<?= $empleado->getFechaNacimiento(); ?>">
										</div>
									</div>
								</div>
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" name="txtNumeroDocumento" id="txtNumeroDocumento"  class="form-control" value="<?= $empleado->getNumeroDocumento(); ?>">
										</div>
									</div>	
								</div>
							</section>
